<template>
  <div class="app">
    <div class="container">
  <img class="logo" src="@/assets/logo-vita.png" alt="">
  <router-view/>
  </div>
  <div id="nav">
    <router-link to="/">
      <img src="@/assets/new-calc.png" alt="">
      Nowa kalkulacja
    </router-link> 
...
.container{
  ...
  margin:0 auto;
  background: white;
  -webkit-box-shadow: 0px 8px 75px -16px rgba(66, 68, 90, 1);
  -moz-box-shadow: 0px 8px 75px -16px rgba(66, 68, 90, 1);
