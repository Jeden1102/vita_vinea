<template>
  <div class="home">
    <vue-html2pdf :show-layout="true" :float-layout="false" :enable-download="true" :preview-modal="false"
      :paginate-elements-by-height="1400" :filename="result.title" :pdf-quality="2" :manual-pagination="false"
          ...
          <div>
            ...
            <div class="table-wrapper">
              <table id="table">
                ...
                <tr>
                  <td>Obwód</td>
                  <td>{{ result.circuit }} m</td>
                </tr>
                <tr>
                  <td>Powierzchnia</td>
                  <td>{{ result.surface }} m2</td>
                </tr>
                <tr>
                  <td>Ilość rzędów</td>
                  <td>{{ result.getRowNumber }}</td>
                </tr>
              </table>
            </div>
          </div> <button @click="generateReport" class="button button--primary">Generuj PDF</button>
